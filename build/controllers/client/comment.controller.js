        ...
        const commentsWithLikeStatus = comments.map((comment) => {
            ...
            const userInfo = comment.userId
                ? {
                    ...
                    fullName: comment.userId.username || "Unknown User",
...
export const addComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const populatedComment = yield Comment.findById(newComment._id).populate({
            path: "userId",
            select: "username avatar",
        });
...
export const likeComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { commentId } = req.params;
        const userId = (_a = res.locals.user) === null || _a === void 0 ? void 0 : _a.id;
        ...
        const likedIndex = comment.likedBy.findIndex((id) => id.toString() === userId.toString());
        if (likedIndex > -1) {
